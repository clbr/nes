...
//óñòàíîâêà ôëàãîâ SZ ïî ðåçóëüòàòàì îïåðàöèè

#define PR_SET_SZ(val)	{ PR&=~(FLG_S|FLG_Z); PR|=((val)&128)|((val)?0:FLG_Z); }

//÷òåíèå àäðåñà/îïåðàíäà ïî ðàçíûì ñõåìàì àäðåñàöèè
...
//ìàòåìàòèêà (ñ ïîääåðæêîé decimal mode)
...
//íåäîêóìåíòèðîâàííûå îïåðàöèè - çàãðóçêà ðåãèñòðîâ
...
//íåäîêóìåíòèðîâàííûå îïåðàöèè - äåêðåìåíò/ñðàâíåíèå
...
//íåäîêóìåíòèðîâàííûå îïåðàöèè - ñäâèãè
...
//íåäîêóìåíòèðîâàííûå îïåðàöèè - ëîãè÷åñêèå îïåðàöèè
